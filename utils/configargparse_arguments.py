...
def build_configargparser(parser, args=None):
    ...
    parser.add_argument("--dataset_kind", default="phantom",
                        choices=["phantom", "human"],
                        help="Selects the label-map convention for us_rendering_model "
                             "(phantom: labels 1-25, human: 0-17).")
    ...
    parser.add_argument("--generate_us_dataset", action="store_true")
    parser.add_argument("--us_dataset_size", type=int, required=False)
    ...
    known_args = parser.parse_args(args=args)
